...
const App = () => {
  ...
  return (
    <div className="border-4 border-gray-700 rounded-lg p-8 w-[500px] flex items-center space-x-12">
      {/* Image Box */}
      <div className="border-4 border-gray-700 rounded-lg w-40 h-40 overflow-hidden ml-6">
        <img 
      ...
      <div className="flex-grow space-y-4">
        <div>
          ...
          <div className="flex space-x-20 bg-white p-3 rounded-lg shadow-md">
